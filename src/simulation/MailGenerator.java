...
public class MailGenerator {
    ...
    private MailItem generateMail(){
        ...
        int mailType = 0;// generateMailType(); //havent written function but will just be random generator of 1 & 0
        ...
        {
        	newMailItem = new MailItem(destinationFloor,arrivalTime,weight, mailType);
        } else {
        	newMailItem = new PriorityMailItem(destinationFloor,arrivalTime,weight, priorityLevel, mailType);
        }
        return newMailItem;
    }
